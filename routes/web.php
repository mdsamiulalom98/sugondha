...
use App\Http\Controllers\Admin\mcqSubjectController;
use App\Http\Controllers\Admin\mcqTopicController;
...
Route::get('/clear-cooldown}', [FrontendController::class, 'coolDown'])->name('cool.down');
...
// ajax route
Route::get('/ajax-subject-topic', [MCQcontroller::class, 'getTopic']);
...
Route::group(['namespace' => 'Admin', 'middleware' => ['auth', 'lock', 'check_refer'], 'prefix' => 'admin'], function () {
    ...
    // mcqSubjects
    Route::get('mcq-subject/manage', [mcqSubjectController::class, 'index'])->name('mcqSubject.index');
    Route::get('mcq-subject/{id}/show', [mcqSubjectController::class, 'show'])->name('mcqSubject.show');
    Route::get('mcq-subject/create', [mcqSubjectController::class, 'create'])->name('mcqSubject.create');
    Route::post('mcq-subject/save', [mcqSubjectController::class, 'store'])->name('mcqSubject.store');
    Route::get('mcq-subject/{id}/edit', [mcqSubjectController::class, 'edit'])->name('mcqSubject.edit');
    Route::post('mcq-subject/update', [mcqSubjectController::class, 'update'])->name('mcqSubject.update');
    Route::post('mcq-subject/inactive', [mcqSubjectController::class, 'inactive'])->name('mcqSubject.inactive');
    Route::post('mcq-subject/active', [mcqSubjectController::class, 'active'])->name('mcqSubject.active');
    Route::post('mcq-subject/destroy', [mcqSubjectController::class, 'destroy'])->name('mcqSubject.destroy');

    // mcqTopics
    Route::get('mcq-topic/manage', [mcqTopicController::class, 'index'])->name('mcqTopic.index');
    Route::get('mcq-topic/{id}/show', [mcqTopicController::class, 'show'])->name('mcqTopic.show');
    Route::get('mcq-topic/create', [mcqTopicController::class, 'create'])->name('mcqTopic.create');
    Route::post('mcq-topic/save', [mcqTopicController::class, 'store'])->name('mcqTopic.store');
    Route::get('mcq-topic/{id}/edit', [mcqTopicController::class, 'edit'])->name('mcqTopic.edit');
    Route::post('mcq-topic/update', [mcqTopicController::class, 'update'])->name('mcqTopic.update');
    Route::post('mcq-topic/inactive', [mcqTopicController::class, 'inactive'])->name('mcqTopic.inactive');
    Route::post('mcq-topic/active', [mcqTopicController::class, 'active'])->name('mcqTopic.active');
    Route::post('mcq-topic/destroy', [mcqTopicController::class, 'destroy'])->name('mcqTopic.destroy');

    // mcq
    Route::get('mcq/manage', [MCQcontroller::class, 'index'])->name('mcq.index');
    Route::get('mcq/{id}/show', [MCQcontroller::class, 'show'])->name('mcq.show');
    Route::get('mcq/create', [MCQcontroller::class, 'create'])->name('mcq.create');
    Route::post('mcq/save', [MCQcontroller::class, 'store'])->name('mcq.store');
    Route::get('mcq/{id}/edit', [MCQcontroller::class, 'edit'])->name('mcq.edit');
    Route::post('mcq/update', [MCQcontroller::class, 'update'])->name('mcq.update');
    Route::post('mcq/inactive', [MCQcontroller::class, 'inactive'])->name('mcq.inactive');
    Route::post('mcq/active', [MCQcontroller::class, 'active'])->name('mcq.active');
    Route::post('mcq/destroy', [MCQcontroller::class, 'destroy'])->name('mcq.destroy');
