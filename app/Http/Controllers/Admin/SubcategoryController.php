...
class SubcategoryController extends Controller
{
    ...
    {
        $data = Subcategory::orderBy('id','DESC')->select('id','name','category_id','status','front_view')->with('category')->get();
    ...
    public function edit($id)
    {
        ...
        $categories = Category::select('id','slug','name','status','front_view')->where('status',1)->get();
