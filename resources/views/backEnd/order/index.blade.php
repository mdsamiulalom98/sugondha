                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="button-list custom-btn-list">
                                            <a href="{{route('admin.order.slip',['invoice_id'=>$value->invoice_id])}}"
                                                title="Slip"><i class="fe-eye"></i></a>
                                    ...
                                    <td><a href="{{ route('admin.order.invoice', ['invoice_id' => $value->invoice_id]) }}"><u>{{$value->invoice_id}}</u></a> <br> {{$value->customer_ip}}
                                    </td>
