                    ...
                    <li class="dropdown notification-list topbar-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end profile-dropdown">
                            ...
                            <div class="dropdown-divider"></div>
                             <a href="{{ url('/cc') }}" class="dropdown-item notify-item">
                                <i class="fe-trash"></i>
                                <span>Cache Crear</span>
                            </a>
                            <!-- item-->
                            <a href="{{ route('logout') }}"
            ...
            <div class="h-100" data-simplebar>
                ...
                <div id="sidebar-menu">
                    ...
                    <ul id="side-menu">
                        ...
                        <li>
                            <a href="#sidebar-mcq-manage" data-bs-toggle="collapse">
                                <i data-feather="users"></i>
                                <span> MCQ Manage </span>
                                <span class="menu-arrow"></span>
                            </a>
                            <div class="collapse" id="sidebar-mcq-manage">
                                <ul class="nav-second-level">
                                    <li>
                                        <a href="{{ route('mcqSubject.index') }}"><i data-feather="minus"></i>MCQ Subject</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('mcqTopic.index') }}"><i data-feather="minus"></i>MCQ Topic</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('mcq.index') }}"><i data-feather="minus"></i>MCQ</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
                        ...
                        <li>
                            ...
                            <div class="collapse" id="siebar-sitesetting">
                                <ul class="nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{route('newsticker.index')}}"><i data-feather="minus"></i>
                                            News Stiker</a>
                                    </li>
