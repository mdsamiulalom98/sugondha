...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ asset('public/frontEnd/css/lightbox.css') }}" />
        <!-- toastr css -->
    ...
    <div class="desktop-menu">
        ...
        <li class="parent-category">
            ...
            <ul class="second-nav" style="display: none;">
                @foreach($scategory->subcategories as $subcategory)
                <li class="parent-subcategory">
                    <a href="{{url('subcategory/'.$subcategory->slug)}}" class="menu-subcategory-name">{{$subcategory->name}}</a>
                    @if($subcategory->childcategories->count() > 0)
                    <span class="menu-subcategory-toggle"><i class="fa fa-chevron-down"></i></span>
                    @endif
                    <ul class="third-nav" style="display: none;">
                        @foreach($subcategory->childcategories as $childcat)
                        <li class="childcategory"><a href="{{url('products/'.$childcat->slug)}}" class="menu-childcategory-name">{{$childcat->name}}</a></li>
                        @endforeach
                    </ul>
                </li>
                @endforeach
            ...
            <div class="mobile-header sticky">
                <div class="mobile-logo">
                    ...
                    <div class="menu-logo">
                     ...
                     <div class="search__mobile"><a class="search_toggles"><i class="fas fa-search"></i></a></div>
                    <div class="menu-bag">
              ...
              <div class="mobile-search main-search mobile__search__sec">
            ...
            <div class="search_body">
                <form action="{{route('search')}}">
                    <div class="form-group form_inner">
                        <input type="text" class="search_keyword search_click" name="keyword" placeholder="Search here...">
        ...
        <script>
           ...
           $(".search_toggles").on("click", function () {
                if ($(".mobile__search__sec").hasClass("active")) {
                    ...
                    $(".mobile__search__sec").addClass("active");
                }
            });
