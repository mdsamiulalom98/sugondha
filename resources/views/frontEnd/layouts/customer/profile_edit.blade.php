                    ...
                    <form action="{{route('customer.profile_update')}}" method="POST" class="row" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="profession" class="form-control @error('profession') is-invalid @enderror" name="profession" value="{{$profile_edit->profession}}"  required>
                                @error('profession')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" id="dob" class="form-control @error('dob') is-invalid @enderror" name="dob" value="{{$profile_edit->dob}}"  required>
                                @error('dob')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
